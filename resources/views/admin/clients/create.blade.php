...
<div class="max-w-5xl mx-auto px-4 py-6 bg-slate-50 dark:bg-slate-900 min-h-screen">
        ...
        <div class="flex justify-between items-center flex-wrap gap-5">
            <div class="flex flex-col gap-4">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/50 dark:to-indigo-800/50 text-indigo-600 dark:text-indigo-400 rounded-xl flex items-center justify-center">
                    ...
                    <div>
                        <h3 class="text-2xl font-bold text-slate-800 dark:text-white mb-1">Add New Client</h3>
                        <p class="text-sm text-slate-500 dark:text-slate-400">Fill in the details to create a new client record</p>
                    </div>
                </div>
            </div>
            <div class="flex items-center gap-2 bg-slate-50 dark:bg-slate-700/50 px-4 py-2 rounded-full">
                ...
                <div class="w-8 h-0.5 bg-slate-200 dark:bg-slate-600"></div>
                <div class="w-8 h-8 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-full flex items-center justify-center text-xs font-bold text-slate-400 dark:text-slate-500">2</div>
                <div class="w-8 h-0.5 bg-slate-200 dark:bg-slate-600"></div>
                <div class="w-8 h-8 bg-white dark:bg-slate-700 border-2 border-slate-200 dark:border-slate-600 rounded-full flex items-center justify-center text-xs font-bold text-slate-400 dark:text-slate-500">3</div>
            </div>
        </div>
    </div>
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div class="bg-white dark:bg-slate-800 rounded-xl p-3.5 flex items-center gap-3 border-l-4 border-indigo-500 shadow-sm">
            ...
            <div class="text-sm text-slate-600 dark:text-slate-400">
                <strong class="text-slate-800 dark:text-slate-200">Tip:</strong> Ensure all mandatory fields are filled correctly
            </div>
        </div>
        <div class="bg-white dark:bg-slate-800 rounded-xl p-3.5 flex items-center gap-3 border-l-4 border-indigo-500 shadow-sm">
            <div class="w-8 h-8 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center text-indigo-600 dark:text-indigo-400">
            ...
            <div class="text-sm text-slate-600 dark:text-slate-400">
                <strong class="text-slate-800 dark:text-slate-200">Tip:</strong> GST number should be in format: XX-XXXXX-XXXX
            </div>
        </div>
    </div>
</div>
