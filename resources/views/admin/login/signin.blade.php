...
<body class="bg-gray-100 font-sans">
    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-200 p-4">

        <div class="w-full max-w-md bg-white/90 backdrop-blur-lg shadow-2xl rounded-2xl overflow-hidden border">

            <!-- Header -->
            <div class="bg-gradient-to-r from-blue-700 to-blue-900 p-6 text-center">
            ...
            <!-- Form -->
            <div class="p-8">
                <form method="POST" action="{{ route('login.admin') }}" id="loginForm" class="space-y-5">
                    @csrf
                    ...
                    <button type="submit" id="loginBtn"
                        class="w-full bg-blue-700 hover:bg-blue-800 text-white py-3 rounded-xl font-semibold shadow-lg transition">
