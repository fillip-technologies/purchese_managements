            ...
            <div class="grid gap-8 xl:grid-cols-[320px_1fr]">
                <aside class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
                    <div class="flex items-center gap-4">
                        <div
                            class="flex h-16 w-16 items-center justify-center rounded-3xl bg-primary text-3xl font-semibold text-white">
                ...
                <div class="space-y-8">
                    <section class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <form action="{{ route('profile.updated', $user->id) }}" method="POST" class="space-y-6">
                            @csrf
                    ...
                    <section class="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <form action="{{ route('password.update',$user->id) }}" method="POST" class="space-y-6">
                            @csrf
                            <div class="grid gap-6 sm:grid-cols-2">
                                <div>
